...
my_coin.add_block(Block(datetime.datetime.now(), 'Transaction 1', ''))
my_coin.add_block(Block(datetime.datetime.now(), 'Transaction 2', ''))
my_coin.add_block(Block(datetime.datetime.now(), 'Transaction 3', ''))
